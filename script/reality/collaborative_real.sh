...
--tab -e 'bash -c "sleep 5; roslaunch px4_application base_uav_control.launch; exec bash"' \
--tab -e 'bash -c "sleep 5; roslaunch px4_application base_gcs_display.launch; exec bash"' \
