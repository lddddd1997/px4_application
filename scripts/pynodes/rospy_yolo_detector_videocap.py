...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
    ...
    rospy.init_node('yolo_detector_without_socket') # 初始化后LOGGER.info无法使用
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=model_file, help='model path(s)')
    ...
    parser.add_argument('--nosave', action='store_true', help='do not save images/videos') # store_false不保存
