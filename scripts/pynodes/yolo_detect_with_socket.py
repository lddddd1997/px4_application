    ...
    for path, img, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                #                 # 目标数，目标编号，x1，y1，x2，y2，conf，cls
                #     print('target_cnt', type(target_cnt))
                #     print('target_num', type(target_num))
                #     print('x1', type(int(target_info[0])))
                #     print('y1', type(int(target_info[1])))
                #     print('x2', type(int(target_info[2])))
                #     print('y2', type(int(target_info[3])))
                #     print('conf', type(target_info[4]))
                #     print('cls', type(target_info[5]))
                # print('---------------------------')
